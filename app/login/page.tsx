    ...
    <div className="min-h-screen bg-brand-dark flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-brand-card border border-brand-border rounded-2xl p-8 shadow-2xl relative overflow-hidden">
        ...
        <div className="flex flex-col items-center mb-8 relative z-10">
          ...
          <p className="text-brand-text-dim text-sm mt-2">Acesse sua conta para gerenciar suas finanças</p>
        </div>
        ...
        <div className="mt-8 text-center relative z-10">
          <p className="text-brand-text-dim text-sm">
            ...
            <Link href="/register" className="text-brand-orange hover:text-brand-orange/80 hover:underline font-semibold transition-colors">
              Criar Conta Grátis
            </Link>
          </p>
        </div>
